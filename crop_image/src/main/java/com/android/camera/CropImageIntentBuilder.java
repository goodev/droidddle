...
public class CropImageIntentBuilder {
     ...
     * @since 1.0.1
     */
    public CropImageIntentBuilder(final int aspectX, final int aspectY, final int outputX, final int outputY, final Uri saveUri) {
     ...
     *
     * @param bitmap The {@link android.graphics.Bitmap} to crop.
     * @return This Builder object to allow for chaining of calls to set methods.
     * @since 1.0.1
     */
    ...
    /**
     * Set output format of the image to crop. If not set, PNG will be used.
     *
