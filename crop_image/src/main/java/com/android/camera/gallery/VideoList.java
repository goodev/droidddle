...
public class VideoList extends BaseImageList {
    ...
    private static final String[] VIDEO_PROJECTION = new String[]{Media._ID, Media.DATA, Media.DATE_TAKEN, Media.TITLE, Media.MINI_THUMB_MAGIC, Media.MIME_TYPE, Media.DATE_MODIFIED};
    ...
    protected BaseImage loadImageFromCursor(Cursor cursor) {
        ...
        return new VideoObject(this, mContentResolver, id, cursor.getPosition(), contentUri(id), dataPath, mimeType, dateTaken, title);
    }
