...
public class VideoObject extends BaseImage implements IImage {
     ...
     */
    protected VideoObject(BaseImageList container, ContentResolver cr, long id, int index, Uri uri, String dataPath, String mimeType, long dateTaken, String title) {
