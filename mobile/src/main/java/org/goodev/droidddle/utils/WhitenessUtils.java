...
public class WhitenessUtils {
    ...
    public static boolean isBitmapWhiteAtTopOrBottom(Bitmap largeBitmap) {
        ...
        try {
            ...
            smallBitmap.getPixels(rgbPixels, 0, smallBitmap.getWidth(), 0, 0, smallBitmap.getWidth(), smallBitmap.getHeight());
            ...
            int totalPixels = (int) (smallBitmap.getHeight() * smallBitmap.getWidth() * THIRD * HEIGHT_PERCENT_ANALYZED);
            ...
            whiteCount = 0;
            for (int y = (int) (smallBitmap.getHeight() * (1 - HEIGHT_PERCENT_ANALYZED)); y < smallBitmap.getHeight(); y++) {
