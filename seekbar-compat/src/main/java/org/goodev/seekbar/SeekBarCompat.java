...
public class SeekBarCompat extends SeekBar implements View.OnTouchListener {
    ...
    public SeekBarCompat(final Context context, final AttributeSet attrs) {
        ...
        try {
            ...
            mProgressColor = a.getColor(R.styleable.SeekBarCompat_seekColor, getPrimaryColorFromSelectedTheme(context));
            mProgressBackgroundColor = a.getColor(R.styleable.SeekBarCompat_seekBackgroundColor, Color.BLACK);
